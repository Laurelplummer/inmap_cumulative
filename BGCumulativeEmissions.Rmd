...
if(!require(pacman)){install.packages("pacman");
  library(pacman)}
p_load(readxl, dplyr, tidyr, tidyverse, ggplot2, janitor, scales, wesanderson, sf, rgdal, naniar)
...
#1. BG mean centers of population from txt file available through the Census online https://www.census.gov/geographies/reference-files/2010/geo/2010-centers-population.html
BG_popwt <- read.delim("Data/US_Census/Spatial_Data/CenPop2010_Mean_BG06.txt", header = TRUE, sep = ",", dec = ".", colClasses = "character") %>%
